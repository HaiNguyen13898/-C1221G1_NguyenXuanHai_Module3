...
<table class="table" id="tableCustomer" class="table table-striped table-bordered" style="width:100%">
    ...
    <c:forEach var="product" items="${productList}">
        <tr>
            ...
            <td><a href="/products?action=edit&id=${product.getIdProduct()}">Sửa</a></td>
            <td>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                        onclick="deleteProduct(${product.getIdProduct()})">
                    Xoá
                </button>
            </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="id" id="deleteProduct">
                    Bạn có chắc muốn xóa sản phẩm? <br>
                    <p style="color: red">Không thể hoàn tác</p>
<%--                    Mã sản phẩm: <p id="id"></p>--%>
<%--                    Tên sản phẩm: <p id="nameProduct"></p>--%>
                </div>
...
<script>
    function deleteProduct(id) {
        document.getElementById("deleteProduct").value = id;

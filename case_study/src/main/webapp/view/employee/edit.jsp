            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ho_ten" size="45"
                           value="<c:out value="${employees.getNameEmployee()}"/>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="date" name="ngay_sinh" size="45"
                           value="<c:out value="${employees.getDateBirth()}"/>"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text"  name="so_cmnd" size="45"
                           value="<c:out value="${employees.getIdCardEmployee()}"/>">
                </td>
            </tr>
            <tr>
                <th>Lương: </th>
                <td>
                    <input type="text" name="luong" size="45"
                           value="<c:out value="${employees.getSalary()}" /> "/>
                </td>
            </tr>
            <tr>
                <th>Số điện thoại: </th>
                <td>
                    <input type="text" name="so_dien_thoai" size="45"
                           value="<c:out value="${employees.getPhoneNumber()}" />"/>
                </td>
            </tr>
            <tr>
                <th>Email: </th>
                <td>
                    <input type="text" name="email"  size="45"
                           value="<c:out value="${employees.getEmail()}"/>"/>
                </td>
            </tr>
            <tr>
                <th>Địa chỉ: </th>
                <td>
                    <input type="text" name="dia_chi" size="45"
                           value="<c:out value="${employees.getAddress()}"/>"/>
                </td>
            </tr>
            <tr>
                <th>Mã vị trí: </th>
                <td>
                    <input type="text" name="ma_vi_tri" size="45"
                           value="<c:out value="${employees.getIdPosition()}"/>"/>
                </td>
            </tr>
            <tr>
                <th>Mã trình độ: </th>
                <td>
                    <input type="text" name="ma_trinh_do" size="45"
                           value="<c:out value="${employees.getIdEducationDegree()}"/>"/>
                </td>
            </tr>
            <tr>
                <th>Mã bộ phận: </th>
                <td>
                    <input type="text" name="ma_bo_phan" size="45"
                           value="<c:out value="${employees.getIdDivision()}"/>"/>
                </td>
            </tr>
